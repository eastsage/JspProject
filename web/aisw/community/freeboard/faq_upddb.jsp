...
<BODY>
<!-- [<A href="faq_list.jsp?go=<%=request.getParameter("page")%>">게시판 목록으로 </A>] -->
 ...
 try {
  ...
  if (!(rs.next()))  {
   ...
   if (pwd.equals(request.getParameter("password"))) {
    ...
    if (cnt >0) {%>
<script>alert('정상적으로 수정되었습니다.'); location.href = "faq_list.jsp?go=<%=request.getParameter("page")%>";</script>
<%} else {
