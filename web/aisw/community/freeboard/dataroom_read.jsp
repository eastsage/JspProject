...
%>
    ...
    <div class="container" style="diplay:inline-block; text-align:center;">
        <td align="right" width="450"><A href="dataroom_list.jsp?go=<%=request.getParameter("page") %>">
            <img src="image/list.jpg" border=0></a></td>
        <td width="70" align="right"><A href="dataroom_rwrite.jsp?id=<%= request.getParameter("id")%>&page=<%=request.getParameter("page")%>"> <img src="image/reply.jpg" border=0></A></td>
        <td width="70" align="right"><A href="dataroom_upd.jsp?id=<%=id%>&page=1"><img src="image/edit.jpg" border=0></A></td>
        <td width="70" align="right"><A href="dataroom_del.jsp?id=<%=id%>&page=1"><img src="image/del.jpg"  border=0></A></td>
        </tr>
    </div>
        <%
