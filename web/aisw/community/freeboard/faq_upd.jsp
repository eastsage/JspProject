...
%>
 <div class="container text-center">
  <FORM name="msgwrite" method=POST action="faq_upddb.jsp?id=<%=id%>&page=<%=p%>">
   ...
   <div class="form-group row">
    <div class="col-12" style="display:inline-block; text-align:center;">
     ...
     &nbsp;&nbsp;
     <A href="faq_list.jsp?go=<%=request.getParameter("page")%>"> <img src="image/list.jpg" border=0 class="img-fluid"></a>
    </div>
   </div>
  </form>
  <%
