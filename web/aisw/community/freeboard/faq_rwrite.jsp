...
// Connection con= null;
 ...
 try {
  ...
  %>
	<div class="container">
		<form name="msgrewrite" action="faq_rsave.jsp?id=<%=id%>&page=<%=request.getParameter("page")%>" class="form-horizontal" method="post">
...
<%=cont%></textarea>
			...
			<div class="form-group row">
				<div class="col-12" style="display:inline-block; text-align:center;">
					...
					&nbsp;&nbsp;
					<a href="faq_list.jsp?go=<%=request.getParameter("page") %>"><img src="image/list.jpg" class="img-fluid"></a>
				</div>
			</div>
